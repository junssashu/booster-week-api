...
MONEYFUSION_BASE_URL = os.getenv('MONEYFUSION_BASE_URL', '')
MONEYFUSION_WEBHOOK_URL = os.getenv('MONEYFUSION_WEBHOOK_URL', 'https://api.boosterweekcenter.com/api/v1/payments/webhook')
